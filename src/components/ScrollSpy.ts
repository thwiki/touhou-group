/**
 * @link https://github.com/withastro/starlight/blob/main/packages/starlight/components/TableOfContents/starlight-toc.ts
 */
...
export class ScrollSpy extends HTMLElement {
	...
	private getRootMargin(): `-${number}px 0% ${number}px` {
		/** Start intersections at 3rem padding. */
		const top = 48;
		/** End intersections `33px` later. This is slightly more than the maximum `margin-top` in Markdown content. */
		const bottom = top + 33;
